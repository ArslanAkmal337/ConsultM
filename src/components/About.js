...
import about1 from "../forms/images/bg-3.jpg";
import about2 from "../forms/images/bg-4.jpg";
const About = () => {
  return (
    <React.Fragment>
          ...
          <div className="row">
            <div className="col-lg-8 mb-5">
              <div className="row">
                <div className="col">
                  <p>
                    <img src={about2} alt="Instant" className="img-fluid" />
                  </p>
                </div>
                <div className="col">
                  <p>
                    <img src={about1} alt="Instant" className="img-fluid" />
                  </p>
                </div>
              </div>
            </div>
